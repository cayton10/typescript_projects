...
/* -------------------------- END BOUNDARY METHODS -------------------------- */

/**
 * Draws 'dot' for our smiley face based on the index range provided
 * Must be within the image bounds (height & width) to set to true
 * @param x 
 * @param y 
 */
